...
//        NetworkInfo wifiInfo = cm.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
    ...
    public static boolean isNetworkOnline1(Context context) {
        ...
        try {
            ...
            @SuppressLint("MissingPermission") NetworkCapabilities capabilities = manager.getNetworkCapabilities(manager.getActiveNetwork());  // need ACCESS_NETWORK_STATE permission
